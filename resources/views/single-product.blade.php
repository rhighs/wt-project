        ...
        <div class="container">
            <div class="row">
                ...
                <div class="left-images">
                    <img src="{{ url('assets/images/single-product-01.jpg') }}" alt="">
                    <img src="{{ url('assets/images/single-product-02.jpg') }}" alt="">
                </div>
            </div>
            <div class="col-lg-4">
            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="first-item">
                        <div class="logo">
                            <img src="{{ url('assets/images/white-logo.png') }}" alt="hexashop ecommerce templatemo">
                        </div>
                        <ul>
